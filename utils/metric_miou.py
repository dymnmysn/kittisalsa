...
def calculate_miou(preds, labels, num_classes=20, ignore_index=0):
...
def calculate_classwise_intersection_union(preds, labels, num_classes=20):
...
def calculate_final_miou_from_batches(batch_results, num_classes=20):
